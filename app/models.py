...
class Vote(Base):
    ...
    user_uuid = Column(Integer, ForeignKey("users.uuid", ondelete="CASCADE"), primary_key=True)
    post_uuid = Column(Integer, ForeignKey("posts.uuid", ondelete="CASCADE"), primary_key=True)
